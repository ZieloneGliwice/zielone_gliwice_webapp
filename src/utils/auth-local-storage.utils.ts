...
export const storeApiAccessToken = (token: string) => localStorage.setItem(apiAccessTokenStorageName, token);

export const clearStoredApiAccessToken = () => localStorage.removeItem(apiAccessTokenStorageName);
